...
export default function DelayedPrepaymentPreOrders() {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await axios.get("https://e-commerce-backend-1-0.onrender.com/api/sellerdelayed-orders");
  ...
  const handleDeleteOrder = async (id) => {
    try {
      await axios.delete(`https://e-commerce-backend-1-0.onrender.com/api/sellerdelayed-orders/${id}`);
