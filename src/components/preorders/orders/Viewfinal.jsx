    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-xl shadow border border-gray-200">
                ...
                {/* Heading */}
                <h2 className="text-xl font-inter text-gray-800 mb-6">Edit Delayed Final Order</h2>

                {/* Form Grid */}
                <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label className="font-inter block mb-1">Product</label>
                        <input
                            type="text"
                            value={item?.product || ""}
                            disabled={!isEditable}
...
export default ViewFinalOrders;
