  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://e-commerce-backend-1-0.onrender.com/api/sellerWholesaleProduct/create",
        formData
      );
  ...
  return (
    <div className="PreOrderFaq-whole ">
      <div className="product-table">
        <p className="customersText mt-6 ml-6">Add new wholesale product</p>
      </div>
          ...
          <div className="product-video-container">
            ...
            <div className="video-input-group">
              ...
              <p className="video-helper-text">
                Use proper link without extra parameters. Don't use short share
                link/embed iframe code.
              </p>
            </div>
          </div>
            ...
            <div className="faqForm">
              <div className=" flex items-center justify-between  w-full">
                ...
                <Switch
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    productData.shippingConfig.freeShipping
                      ? "bg-green-500"
                      : "bg-gray-300"
                  }`}
                >
              ...
              <div className=" flex items-center justify-between w-full">
                ...
                <Switch
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    productData.shippingConfig.flatRate
                      ? "bg-green-500"
                      : "bg-gray-300"
                  }`}
                >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    productData.hideStock ? "bg-green-500" : "bg-gray-300"
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                      productData.hideStock ? "translate-x-6" : "translate-x-1"
                    }`}
                  />
                </button>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    productData.shippingConfig.cashOnDelivery
                      ? "bg-green-500"
                      : "bg-gray-300"
                  }`}
                >
